...
export type AgentPassComposer<TReturns extends [...any[]] = []> = {
   ...
   */
  simulate(): Promise<AgentPassComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: SkipSignaturesSimulateOptions): Promise<AgentPassComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  simulate(options: RawSimulateOptions): Promise<AgentPassComposerResults<TReturns> & { simulateResponse: SimulateResponse }>
  /**
